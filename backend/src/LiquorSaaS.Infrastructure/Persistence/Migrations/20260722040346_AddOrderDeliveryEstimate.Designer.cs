...
namespace LiquorSaaS.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260722040346_AddOrderDeliveryEstimate")]
    partial class AddOrderDeliveryEstimate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LiquorSaaS.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<DateTime?>("EstimateCalculatedAtUtc")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<bool>("IsDeliveryEstimateFallback")
                        .HasColumnType("bit");
